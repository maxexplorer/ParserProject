...
def get_data(data_list):
    ...
    cookies = {
        ...
        '_gid': 'GA1.2.1459596806.1688723394',
        '_gat': '1',
        '_gat_FrontEndTracker': '1',
        '_dc_gtm_UA-157906562-1': '1',
        '_ga_Q2V7P901XE': 'GS1.2.1688723394.5.0.1688723394.0.0.0',
        '_ym_isad': '2',
        'tmr_detect': '0%7C1688723397244',
        'wasm': 'a52c1a768462fea24becb88d4944661c',
    }
    ...
    with requests.Session() as session:
        ...
        for i, tin, full_name, address in data_list[500:700]:
            tin = tin.strip()
