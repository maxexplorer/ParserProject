...
def get_id_categories(headers: dict, params: dict, region: str, id_region: str) -> list:
    id_categories_list = []
    ...
    for category_item in category_items:
        ...
        for subcategory_item in subcategory_items:
            if subcategory_item.get('nameEn') == 'SALE' or subcategory_item.get(
                    'nameEn') == 'COLLECTION' or subcategory_item.get('nameEn') == 'NEW COLLECTION':
    ...
    with open(f'data/id_categories_list_{region}.txt', 'w', encoding='utf-8') as file:
